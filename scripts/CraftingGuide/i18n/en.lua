-- Overrides
STRINGS.INSPECTMOD = "Show Recipes"
...
STRINGS.CRAFTING_GUIDE.REQUIREMENT_ICONS.REQUIRES_BEFRIEND_SPIDER = "Must befriend {spider} to unlock this item"
STRINGS.CRAFTING_GUIDE.REQUIREMENT_ICONS.REQUIRES_SCAN_CREATURE = "Must scan {creatures} to unlock this item"
...
STRINGS.CRAFTING_GUIDE.SETTINGS_CONTENT.GROUP_BY_KNOWLEDGE.RARE_BLUEPRINT = "Recipe is unknown, requires rare blueprint"
